<template>
    <div class="login-password-container">
        ...
        <div>
            <mt-field label="原始密码:" placeholder="原始密码" type="password" v-model="pwd.beforePassword"></mt-field>
            <mt-field label="新密码:" placeholder="新密码" type="password" v-model="pwd.password"></mt-field>
            <mt-field label="确认新密码:" placeholder="确认新密码" type="password" v-model="pwd.newPassword"></mt-field>
        </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods:{
            save(){
                if (!this.pwd.beforePassword) {
                    prompt.alert('初始密码不能为空!');
                    return
                }
